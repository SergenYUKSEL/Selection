...
if(isset($_POST['formconnexion']))
{
    ...
    {
        $requser = $bdd->prepare("SELECT * FROM professeurs WHERE mail = ? AND password = ?");
        ...
        if($userexist == 1)
        {
          ...
          header("Location: profileprof.php?id=".$_SESSION['id']); 
        }
        else
        {
...
<html>
  <head>
    <title>Page de connexion pour Professeur</title>
